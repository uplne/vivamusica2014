...
define([
    ...
    var Popup = function() {
        ...
        api.sendData = function(data) {
            $.post( "https://fb.core4.sk/slsp_sutaz/index.php", {
                name: data.name,
                email: data.email,
        ...
        api.getMD5 = function(data) {
            var str = "crstr4?." + data.name + data.email + data.phone + data.tickets + data.canvas + data.marketing;
